add_shortcode('fastmedia_asset_detail', function () {
  ...
  $is_brand_approved = get_field('fadd_shortcode('fastmedia_asset_detail', function () {
  if (!is_user_logged_in()) return '<p>Please <a href="/signin/">sign in</a> to view this page.</p>';
      ...
      <div class="download-section">
        ...
        <div class="download-buttons">
          <?php
            ...
            $comp_url = add_query_arg(['action' => 'fastmedia_comp_download', 'id' => $attachment_id], admin_url('admin-ajax.php'));
            echo '<a href="' . esc_url($comp_url) . '" class="download-button comp" download>COMP — Watermarked Preview</a>';
            
            // Add dynamic resize downloads
            $large_url = add_query_arg(['action' => 'fastmedia_resize_download', 'id' => $attachment_id, 'size' => 'large'], admin_url('admin-ajax.php'));
            $medium_url = add_query_arg(['action' => 'fastmedia_resize_download', 'id' => $attachment_id, 'size' => 'medium'], admin_url('admin-ajax.php'));
            $small_url = add_query_arg(['action' => 'fastmedia_resize_download', 'id' => $attachment_id, 'size' => 'small'], admin_url('admin-ajax.php'));
...
<?php
  ...
  return ob_get_clean();
});astmedia_brand_approved', $attachment_id);
  $activity_log = get_post_meta($attachment_id, 'fastmedia_activity_log');
  $label_map = [
    'ST' => 'Stock Image', 'UP' => 'User Upload', 'BR' => 'Brand Approved',
    'LO' => 'Logo', 'FI' => 'Final Approved', 'PH' => 'Photography',
      ...
      <div class="download-section">
        ...
        <div class="download-buttons">
          <?php
            ...
            // Add watermarked comp download
            $comp_url = add_query_arg(['action' => 'fastmedia_comp_download', 'id' => $attachment_id], admin_url('admin-ajax.php'));
            echo '<a href="' . esc_url($comp_url) . '" class="download-button" download>COMP — Watermarked Preview</a>';
          ?>
